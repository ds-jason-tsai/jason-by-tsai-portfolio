...
const WorldMapCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    mapImage.src = '/assets/world_map_black.png';
    ...
    const draw = () => {
      ...
      if (mapImage.complete) {
        ...
        // Force full width or fit properly
        drawW = width;
        drawH = width / imgAspect;
        drawX = 0;
        drawY = (height - drawH) / 2;

        // Draw image (contains pure black background)
        ctx.globalAlpha = 0.8;
        ...
        hubs.forEach(h => {
          ...
          grad.addColorStop(0.5, 'rgba(0, 242, 254, 0.8)');
          ...
          const cpX = (tx + hx) / 2;
          const cpY = Math.min(ty, hy) - (Math.abs(tx - hx) * 0.15);

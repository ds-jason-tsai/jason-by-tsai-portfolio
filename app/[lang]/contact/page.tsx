...
export default async function Contact({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const content = {
    ...
    ja: { title: "お問い合わせ", subtitle: "データ分析、AI活用、MarTech導入に関するご相談はこちらから。あなたのビジネスにデータの力を解き放つ準備はできていますか？", desc: "プロジェクトの特定のニーズ、課題、またはスケジュールを詳細にご記入ください。", name: "名前", email: "メール", msg: "プロジェクトの詳細 / 相談内容", send: "送信する" }
  };

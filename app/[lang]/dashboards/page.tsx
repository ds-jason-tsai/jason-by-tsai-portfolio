...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const titles = { 
    ...
    ja: "データダッシュボード (Dashboards) | Tableau & Looker Studio | Jason Analytics" 
  };
  const descriptions = {
    ...
    ja: "ジェイソン・アナリティクス (Jason Analytics) が提供するデータダッシュボード (Dashboards)。TableauやLooker Studioを用いたビジネスデータ可視化、販売監視や市場分析の設計に精通。データの力を引き出し、意思決定を最適化しましょう。"
  };
  return { 

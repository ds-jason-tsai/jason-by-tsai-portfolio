...
export default async function Experience({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const content = {
    zh: { title: "完整職涯經歷", 
          ...
          exp: [
            { date: "2026.01 - Present", role: "合作講師", company: "nSchool (Kolable)", url: "https://kkschool.kolable.app/", desc: "客製化設計 Python 與 AI 學習路徑，打造輕量高效的數據學習體驗。" },
            { date: "2026.01 - Present", role: "合作講師", company: "X Platform", url: "https://www.xplatform.world/", desc: "開設資料分析、AI 應用系列課程，強調端到端專案實作。" },
            { date: "2026.01 - Present", role: "合作講師", company: "無限學院 (OOSchool)", url: "https://www.ooschool.cc/", desc: "輔導超過 50 位學生，完成近百件數據分析專案，涵蓋 Python、建模、視覺化、n8n 自動化、AI 系統建置等。" },
            { date: "2024.08 - Present", role: "合作講師", company: "聯成電腦 (菜鳥救星)", url: "https://live.rookiesavior.net/", desc: "開發從零到一的 Tableau 完整資料生命週期課程；累積 200+ 教學小時，培訓超過 150 位專業人士。成功協助多位學員轉職數據分析師，並獲得 4.8/5.0 的學員滿意度回饋。" },
    ...
    en: { title: "Experience", 
          ...
          exp: [
            { date: "2026.01 - Present", role: "Partner Instructor", company: "nSchool (Kolable)", url: "https://kkschool.kolable.app/", desc: "Designing Python & AI learning paths with a lightweight, project-focused approach." },
            { date: "2026.01 - Present", role: "Partner Instructor", company: "X Platform", url: "https://www.xplatform.world/", desc: "Running data analytics & AI application courses with emphasis on end-to-end projects." },
            { date: "2026.01 - Present", role: "Partner Instructor", company: "No-Limit Academy (OOSchool)", url: "https://www.ooschool.cc/", desc: "Mentored 50+ students in completing nearly 100 data projects across Python, ML, n8n, and AI builds." },
            ...
            { date: "2023 - 2024", role: "Corporate Project: Dashboard Strategist", company: "NTUDAC x Shopee Xpress", url: "", desc: "Specialized in Location Intelligence & Strategic Planning. Built interactive dashboards using scraping and geospatial analysis to optimize logistics operational footprints." },
            { date: "2023", role: "AI Forecasting Champion", company: "Carrefour", url: "", desc: "Developed a customer purchase prediction model using advanced ensemble learning. Secured the National Championship and 'Best Model' Award in a large-scale project competition." },
    ...
    ja: { title: "完全な職歴", 
          ...
          exp: [
            { date: "2026.01 - 現在", role: "パートナー講師", company: "nSchool (Kolable)", url: "https://kkschool.kolable.app/", desc: "Python・AIの学習ロードマップを設計。軽量でプロジェクト重視のアプローチ。" },
            { date: "2026.01 - 現在", role: "パートナー講師", company: "X Platform", url: "https://www.xplatform.world/", desc: "データ分析・AIアプリケーションコースを担当。エンドツーエンドのプロジェクト実践を重視。" },
            { date: "2026.01 - 現在", role: "パートナー講師", company: "無限学院 (OOSchool)", url: "https://www.ooschool.cc/", desc: "50人以上の受講生を指導し、Python・ML・n8n自動化・AIシステム実装などを含む近百件のプロジェクトを完遂。" },

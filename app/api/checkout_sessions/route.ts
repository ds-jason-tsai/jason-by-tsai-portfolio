...
const REPORT_CATALOG: Record<string, { name: string; price: number }> = {
  salesforce_se: { name: 'Salesforce SE Pitch', price: 1 },
  notebooklm_series: { name: 'NotebookLM Guide', price: 1 },
  notebooklm_ja_learning: { name: 'NotebookLM Japanese', price: 1 },
  notebooklm_biz_analysis: { name: 'NotebookLM Biz Analysis', price: 1 },
  notebooklm_chat_summary: { name: 'NotebookLM Chat Summary', price: 1 },
  notebooklm_finance_stock: { name: 'NotebookLM Finance', price: 1 },
  insurance_raw_data: { name: 'Insurance Social Raw Data (20yr)', price: 1 },
};
...
export async function POST(request: Request) {
  try {
    ...
    const params: Record<string, string> = {
      ...
      TotalAmount: String(customPrice || 1),
